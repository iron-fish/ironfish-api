/*
  ...
  - A unique constraint covering the columns `[transaction_hash,graffiti,type]` on the table `masp_transactions` will be added. If there are existing duplicate values, this will fail.
...
-- AlterTable
ALTER TABLE "masp_transactions" ADD COLUMN     "graffiti" VARCHAR NOT NULL;
...
-- CreateIndex
CREATE UNIQUE INDEX "uq_masp_on_transaction_hash_graffiti_type" ON "masp_transactions"("transaction_hash", "graffiti", "type");
